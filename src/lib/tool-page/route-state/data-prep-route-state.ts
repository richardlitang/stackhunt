import { buildToolPageEvidenceSignalsStateInputFromRoute } from '@/lib/tool-page/evidence/evidence-signals-route-input';
import { buildToolPageEvidenceSignalsState } from '@/lib/tool-page/evidence/evidence-signals-state';
import { buildToolPageDecisionSectionStateInputFromRoute } from '@/lib/tool-page/decision/decision-section-route-input';
import { buildToolPageDecisionSectionState } from '@/lib/tool-page/decision/decision-section-state';
import { buildToolPagePrepStateInputFromRoute } from '@/lib/tool-page/route-state/prep-input';
import { buildToolPagePrepState } from '@/lib/tool-page/route-state/prep-state';
import { deriveToolPageReviewContextSignals } from '@/lib/tool-page/evidence/review-context';
import { buildToolPageReviewArtifactsState } from '@/lib/tool-page/evidence/review-artifacts-state';
import {
  toToolPageOptionalRecord,
  toToolPageReviewSources,
} from '@/lib/tool-page/shared/route-normalizers';
import { hasSupportData } from '@/lib/tool-page/presentation/knowledge-card-presence';
import type { ToolPageData } from '@/lib/tool-page/data/data';
