import { buildToolPageAlternativesRuntimeFromItems } from '@/lib/tool-page/alternatives/alternatives-runtime';
import { buildToolPageAlternativesViewFields } from '@/lib/tool-page/alternatives/alternatives-view-fields';
import { createToolPageEvidenceBulletAdapters } from '@/lib/tool-page/evidence/evidence-bullet-adapters';
import { countEligibleEvidenceDomains } from '@/lib/tool-page/evidence/evidence-policy';
import {
