import { buildToolPageAboutContent } from '@/lib/tool-page/presentation/about-content';
...
import { buildToolPageGettingStartedProps } from '@/lib/tool-page/presentation/getting-started-props';
import { buildToolPageOperationalDetailsState } from '@/lib/tool-page/presentation/operational-details';
import { buildToolPagePlatformSectionState } from '@/lib/tool-page/presentation/platform-section';
import { buildToolPagePricingEvidenceState } from '@/lib/tool-page/pricing/pricing-evidence-state';
import { buildToolPagePricingNotice } from '@/lib/tool-page/pricing/pricing-notice';
import { buildToolPagePricingSectionState } from '@/lib/tool-page/pricing/pricing-section';
import { buildToolPageProsConsView } from '@/lib/tool-page/presentation/pros-cons-view';
import { buildToolPageSourceListsView } from '@/lib/tool-page/evidence/source-lists';
import { buildToolPageSpecsProps } from '@/lib/tool-page/presentation/specs-props';
import { buildToolPageSpecsSectionState } from '@/lib/tool-page/presentation/specs-section';
import { buildToolPageStrengthsSubtitle } from '@/lib/tool-page/presentation/strengths-subtitle';
