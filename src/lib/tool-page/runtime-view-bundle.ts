...
import type { buildToolPageRuntime } from '@/lib/tool-page/runtime';
...
export function buildToolPageRuntimeViewBundle(input: BuildToolPageRuntimeViewBundleInput): {
  ...
  updateHistoryEntries: ReturnType<typeof buildToolPageRuntime>['trustRuntime']['updateHistoryEntries'];
