...
import type { BuildToolPageRuntimeInputParams } from '@/lib/tool-page/runtime/runtime-input';
import type { ReviewLens } from '@/lib/tool-page/presentation/view-model';
import type { ToolPageEvidenceBulletV2 } from '@/lib/tool-page/evidence/evidence-bullets';
import type { ToolPageEvidenceGrade } from '@/lib/tool-page/evidence/trust';
import { stripToolPageControlChars } from '@/lib/tool-page/shared/text';
