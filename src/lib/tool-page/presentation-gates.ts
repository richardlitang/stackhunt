...
export function buildToolPagePresentationGates(
  input: BuildToolPagePresentationGatesInput
): {
  ...
  return {
    showProceduralVerdict:
      input.hasProceduralGuidance && input.sectionStatus.verdict === 'procedural' && !input.hasVerdict,
    showProceduralSpecs:
