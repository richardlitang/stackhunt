import type { ToolPageAlternativesState } from '@/lib/tool-page/alternatives-state';

export function buildToolPageAlternativesViewFields(
  alternativesState: ToolPageAlternativesState
): {
