...
export function deriveToolPageBaseEvidenceGrade(
  ...
  if (
    officialDomains.size >= 1 &&
    (input.canonicalHardLimitCount > 0 || hasOfficialDocOrHelpSource)
  ) {
    return 'B';
  }
