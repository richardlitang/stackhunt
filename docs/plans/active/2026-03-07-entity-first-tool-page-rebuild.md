...
- 2026-03-17 progress: added explicit canonical subject precedence (`resolveToolPageCanonicalSubject(...)`) so low-confidence lane subjects only yield to specific non-core heuristic subjects, never generic core fallback.
