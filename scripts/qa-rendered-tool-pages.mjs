  ...
  const requiredMarkers = [
    {
      label: 'qa_gate_wired',
      pattern:
        /\b(buildToolPageRuntimeNavigationRouteState|buildToolPageRuntimeRouteState|buildToolPageRuntimeNavigationStateFromDecisionContext|buildToolPageRuntimeViewBundleFromDecisionContext|buildToolPageRuntimeViewBundleFromPageContext|buildToolPageRuntimeAssemblyFromRoute|buildToolPageRuntimeAssembly|buildToolPageRuntimeContext|evaluateToolPageQaGate)\(/,
    },
    {
