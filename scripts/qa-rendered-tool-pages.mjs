  ...
  const requiredMarkers = [
    {
      label: 'qa_gate_wired',
      pattern:
        /\b(buildToolPagePageAssemblyRouteStateFromRouteContext|buildToolPageRuntimeMidRouteState|buildToolPageRuntimeNavigationRouteState|buildToolPageRuntimeRouteState|buildToolPageRuntimeNavigationStateFromDecisionContext|buildToolPageRuntimeViewBundleFromDecisionContext|buildToolPageRuntimeViewBundleFromPageContext|buildToolPageRuntimeAssemblyFromRoute|buildToolPageRuntimeAssembly|buildToolPageRuntimeContext|evaluateToolPageQaGate)\(/,
    },
    {
