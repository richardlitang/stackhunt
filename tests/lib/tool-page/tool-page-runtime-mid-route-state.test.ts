...
vi.mock('@/lib/tool-page/route-state/lens-hard-limit-route-state', () => ({
  buildToolPageLensHardLimitRouteState: buildToolPageLensHardLimitRouteStateMock,
}));

vi.mock('@/lib/tool-page/route-state/specs-category-route-state', () => ({
  buildToolPageSpecsCategoryRouteState: buildToolPageSpecsCategoryRouteStateMock,
}));

vi.mock('@/lib/tool-page/route-state/runtime-navigation-route-state', () => ({
