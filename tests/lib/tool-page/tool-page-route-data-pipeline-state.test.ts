...
vi.mock('@/lib/tool-page/route-state/data-prep-route-state', () => ({
  buildToolPageDataPrepRouteState: buildDataPrepMock,
}));

vi.mock('@/lib/tool-page/decision/decision-evidence-route-state', () => ({
  buildToolPageDecisionEvidenceRouteState: buildDecisionEvidenceMock,
}));

vi.mock('@/lib/tool-page/route-state/display-route-state', () => ({
  buildToolPageDisplayRouteState: buildDisplayStateMock,
}));

vi.mock('@/lib/tool-page/route-state/runtime-mid-route-state', () => ({
  buildToolPageRuntimeMidRouteState: buildRuntimeMidStateMock,
}));

import { buildToolPageRouteDataPipelineStateFromPageContext } from '@/lib/tool-page/route-state/route-data-pipeline-state';
