...
import { buildToolPageRuntimeContext } from '@/lib/tool-page/runtime/runtime-context';
import { buildToolPageRuntimeParamsContext } from '@/lib/tool-page/route-state/runtime-params-context';
...
describe('tool page runtime assembly', () => {
  it('matches the previous params -> runtime -> bundle chain', () => {
    ...
    expect(assembled.sourceAriaLabel('official_docs')).toEqual(
      previous.sourceAriaLabel('official_docs')
    );
