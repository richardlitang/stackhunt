...
vi.mock('@/lib/tool-page/core-state', () => ({
  deriveToolPageCoreState: deriveToolPageCoreStateMock,
}));

vi.mock('@/lib/tool-page/review-content', () => ({
